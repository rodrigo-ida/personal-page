  ...
  animation: ${(props) => {
      ...
      if (props.clicked) {
        if (props.position === "top") {
          return openAnimationTop;
        }
        if (props.position === "middle") {
          return openAnimationMiddle;
        }
        if (props.position === "bottom") {
          return openAnimationBottom;
        }
      } else {
        if (props.position === "top") {
          return closeAnimationTop;
        }
        if (props.position === "middle") {
          return closeAnimationMiddle;
        }
        if (props.position === "bottom") {
          return closeAnimationBottom;
        }
      }
    }}
    0.3s forwards ease-in;
`;
